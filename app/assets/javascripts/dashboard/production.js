...
Production.prototype.update = function() {
  ...
  if(this.graph) {
    ...
    if (this.dashboard) {
      ...
      data_container.append("text").attr("x", -100).attr("y", 0).text("売上高: ");
      data_container.append("text").attr("y", 0).text(numberFormat(total_sales) + "円");
      data_container.append("text").attr("x", -100).attr("y", 40).text("人件費: ");
      data_container.append("text").attr("y", 40).text(numberFormat(total_staff_cost) + "円");
      data_container.append("text").attr("y", 60).text("(" + rate_format(total_staff_cost / total_sales * 100) + " %)").attr("fill", "darkgray");
      data_container.append("text").attr("x", -100).attr("y", 80).text("外注費: ");
      data_container.append("text").attr("y", 80).text(numberFormat(total_cost) + "円");
      data_container.append("text").attr("y", 100).text("(" + rate_format(total_cost / total_sales * 100) + " %)").attr("fill", "darkgray");
      data_container.append("text").attr("x", -100).attr("y", 120).text("材料費: ");
      data_container.append("text").attr("y", 120).text(numberFormat(total_temporary_cost) + "円");
      data_container.append("text").attr("y", 140).text("(" + rate_format(total_temporary_cost / total_sales * 100) + " %)").attr("fill", "darkgray");
      data_container.append("text").attr("x", -100).attr("y", 160).text("粗利益: ");
      data_container.append("text").attr("y", 160).text(numberFormat(total_profit) + "円");
      data_container.append("text").attr("y", 180).text("(" + rate_format(total_profit / total_sales * 100) + " %)").attr("fill", "darkgray");
    ...
    this.x = d3.scale.ordinal()
      .domain(['sales', 'cost'])
      .rangeBands([0, this.width * 0.6], 0.5, 0.5);
